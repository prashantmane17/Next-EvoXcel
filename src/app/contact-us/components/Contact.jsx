...
const Contactus = () => {
  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 relative z-40">
      <div
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl headingfont font-bold tracking-tight text-gray-900 sm:text-4xl">
          Contact Us
        </h2>
