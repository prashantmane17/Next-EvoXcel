  ...
  return (
    <div className="isolate  px-6 py-24 sm:py-32 lg:px-8 relative z-40">
      ...
      <form
        ref={form}
        onSubmit={sendEmail}
        className="mx-auto mt-16 max-w-xl sm:mt-1 p-6 md:p-0 bg-white md:bg-transparent rounded-md shadow-lg shadow-gray-400 md:shadow-none"
      >
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                ...
                <select id="country" name="country" className="h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-white focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                  <option>IN</option>
                  <option>US</option>
                  <option>CA</option>
                  <option>EU</option>
